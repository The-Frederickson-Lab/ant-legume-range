...
We will use the ant subfamily as a random effect in models, and so need to download it for each ant genus in the dataset.

```{r Get ant subfamily, eval=FALSE, warning=FALSE, message=FALSE}
#Not run
