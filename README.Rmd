...
```{r Read in mutualism and legume range datasets, warning=FALSE, message=FALSE}
#Not run
...
```{r Summarize ant trait data in tables, message=FALSE, warning=FALSE}
...
```{r Latitude, eval=FALSE, warning=FALSE, message=FALSE}
pal="Saguaro"
...
We visualized the latitudinal distribution of each taxon (legumes and ants) to understand how these are distributed globally. This is to address a reviewer comment about whether our dataset is indeed "global."

First, ant maps. 

```{r Ant maps, eval=FALSE, warning=FALSE, message=FALSE}
...
```{r Legume maps, message=FALSE, warning=FALSE}
