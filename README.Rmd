...
nat_inv_area <- merge(invarea, antarea, by='Phy', all.x= FALSE, all.y=TRUE) 
...
efn_area <- merge(nat_inv_area, antefn, by.y = "Phy", all = FALSE)
...
fig4
#ggsave(fig3, device = "jpeg", filename = "Fig4.jpg")
...
#PGLS model
a1 <- gls(lognative ~ EFN + Domatia + Seed_Dispersal + EFN*Domatia + Domatia*Seed_Dispersal + Seed_Dispersal*EFN, 
...
a2 <- gls(logint ~  EFN + Domatia + Seed_Dispersal + EFN*Domatia + Domatia*Seed_Dispersal + Seed_Dispersal*EFN + total.area.native,  correlation = corPagel(1, phy = pruned_ant_tree, form = ~Phy), method = "ML", data = area_phy)  
summary(a2)
